...
CREATE TABLE customers_east PARTITION OF customers_partitioned
    FOR VALUES IN ('EA', 'NE');

CREATE TABLE customers_west PARTITION OF customers_partitioned
    FOR VALUES IN ('WE', 'NW');

CREATE TABLE customers_south PARTITION OF customers_partitioned
    FOR VALUES IN ('SE', 'SW');

-- Insert data into different partitions
INSERT INTO customers_partitioned (name, email, region, join_date)
VALUES
...
-- Note: This may require additional setup in postgresql.conf
